    ...
    const dataClient = [
        {
            ...
            desc: " “ Proin iaculis purus consequat sem cure  digni ssim donec porttitora entum suscipit aenean rhoncus. ” ",
            img: imgclient,
            textRight: true
        },
        {
    ...
    const listClient = clients.map((item) => 
        {
            ...
            return <ClientsItem key={item.name} name={name} desc={desc} img={img} textRight={textRight}/>
        }
    )
    return <div className="clients">
        <div className="container">
            <div className="title">
                ...
                <span> Clients </span>
                <p>
                    See watch nice things our clients said about us.
                </p>
            </div>
