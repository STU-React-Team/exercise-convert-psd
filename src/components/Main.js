...
function Main() {
  ...
  const facebook = 'fab fa-facebook-f';
              ...
              <div className="service-text">
                ...
                <div className="text-descriptioin">
                  <p>
                    ...
                    tincidunt. Proin iaculis purus consequat sem cure digni
                    ssim. Donec porttitora entum suscipit aenean rhoncus posuere
                    odio in tincidunt.
                  </p>
                  <p>
                    Iaculis purus consequat sem cure digni ssim. Donec
                    porttitora entum suscipit aenean rhoncus posuere odio in
                    tincidunt. Proin iaculis purus consequat sem cure digni
                    ssim.
                  </p>
              ...
              <div className="service-text">
                ...
                <div className="text-descriptioin">
                  ...
                  <p>
                    Iaculis purus consequat sem cure digni ssim. Donec
                    porttitora entum suscipit aenean rhoncus posuere odio in
                    tincidunt. Proin iaculis purus consequat.
                  </p>
                </div>
              </div>
            </div>
            ...
            {skills.map(skill => {
              return (
                <div className="d-flex col-md-6">
                  <div className="skill-img d-inline">
            ...
            <div className="d-inline">
              <div className="chat">
                <p className="chat-content">
                  “ Proin iaculis purus consequat sem cure digni ssim donec
                  porttitora entum suscipit aenean rhoncus. ”
                </p>
          ...
          <div className="client-box d-flex">
            <div className="d-inline">
              <div className="chat">
                ...
                <p className="chat-user">
                  - Client-Lisa Simpson, Founder of Rainel
                </p>
              </div>
            </div>
            <div className="d-inline">
