    ...
    return (
        <div className="service-tab col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
			...
			<div className="service-tab-content tab-content">
                ...
                >
                    Flamingos usually stand  while the other is tucked beneath their bodies. The reason for this <br/><br/>behaviour is not fully understood. One theory is that standing on one leg allows the birds to conserve more body heat, given that they spend a significant amount of time wading in cold water.
                </div>
                <div 
                    ...
                    The cuckoos are generally  slender birds. <br/> <br/> Most species live in trees, though a sizeable minority are ground-dwelling.<br/><br/> The family has a cosmopolitan distribution, with the majority of species being tropical.
                </div>
                <div 
                    className="tab-pane fade" 
                    id="ostrich" 
