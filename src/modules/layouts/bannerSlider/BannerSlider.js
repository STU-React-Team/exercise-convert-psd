...
export default function BannerSlider() {
    const content = "Ethernet scan, in indeterminate controller high, recognition frequency silicon logistically. Read-only or boolean potentiometer pc infrared development debugged processor. ";
    const title = `Anhiora Business solutions`;
    return (
        <div id="carouselExampleControls" className="carousel slide banner-slider" data-ride="carousel">
